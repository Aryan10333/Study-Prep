...
def compile_master_guide():
    ...
    <div class="module-container">
        <div style="background-color: #f8fafc; border-bottom: 2px solid #cbd5e1; padding: 12px 0; margin-bottom: 24px;">
            <span style="font-size: 11px; text-transform: uppercase; letter-spacing: 0.1em; color: #64748b; font-weight: 600;">Advanced RAG & Vector Search Master Curriculum</span>
        </div>
        {html_body}
    </div>
"""
...
<head>
    <meta charset="utf-8">
    <title>Advanced RAG & Vector Search Master Study Guide</title>
    <!-- Load KaTeX -->
...
<div class="cover-page" style="text-align: center; padding-top: 140px; page-break-after: always;">
    ...
    <div style="margin-top: 60px; font-size: 13px; color: #475569; line-height: 1.8;">
        ...
        <p><b>Core Modules:</b> RAG Fundamentals, Document Ingestion CDC, Embeddings & Vector Search Math, HNSW/IVF Indexing, Quantization Math, Chunking & RRF Math, Bi-Encoder vs Cross-Encoder, Self-RAG & Agentic Tool-calling, RAG Evaluation (Ragas, MRR, NDCG), Production Streaming & Multi-tenancy, Best Practices & failures, 40 Q&As</p>
        <p><b>Includes:</b> RRF Reciprocal Rank worked equations, NDCG logs hand calculations, IVF VRAM savings math, HTML/CSS vector diagrams, Python/LangChain companion code, 40 High-Frequency Q&As</p>
    </div>
</div>
...
<div class="toc-page" style="page-break-after: always; padding-top: 20px;">
    ...
    <ul style="list-style-type: none; padding-left: 0; margin-top: 20px;">
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#rag-fundamentals" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 01: RAG Fundamentals</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#document-ingestion-indexing-architecture" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 02: Document Ingestion & Indexing Architecture</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#embeddings-vector-search-mechanics" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 03: Embeddings & Vector Search Mechanics</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#chunking-retrieval-strategies" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 04: Chunking & Retrieval Strategies</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#retrieval-optimization" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 05: Retrieval Optimization</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#advanced-agentic-rag-architectures" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 06: Advanced & Agentic RAG Architectures</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#rag-evaluation-benchmarking" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 07: RAG Evaluation & Benchmarking</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#production-rag-systems-infrastructure" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 08: Production RAG Systems & Infrastructure</a></li>
        ...
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#advanced-rag-vector-search-high-frequency-question-bank" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 10: Advanced RAG & Vector Search: High-Frequency Question Bank</a></li>
    </ul>
</div>
