...
def main():
    ...
    print("\n--- Compiling Master GenAI System Design & LLMOps Study Guide ---")
    master_html = os.path.join(base_dir, "genai_system_design_and_llmops_master_study_guide.html")
    master_pdf = os.path.join(base_dir, "genai_system_design_and_llmops_master_study_guide.pdf")

    master_modules = [
        "01_the_genai_system_design_interview_framework.md",
        "02_reference_architectures_for_genai_systems.md",
        "03_capacity_estimation_traffic_modeling_and_cost_engineering.md",
        "04_data_and_knowledge_infrastructure_at_scale.md",
        "05_llmops_foundations_versioning_registries_and_cicd.md",
        "06_deployment_strategies_progressive_rollout_and_experimentation.md",
        "07_reliability_engineering_redundancy_fallbacks_and_multi_provider.md",
        "08_security_privacy_and_compliance_architecture.md",
        "09_end_to_end_genai_system_design_case_studies.md",
    ]
    compile_document(
        master_modules,
        master_html,
        ...
        "GenAI System Design & LLMOps Curriculum Guide",
        subtitle="Interview Framework, Reference Architectures, Capacity/Cost Engineering, Data Infrastructure, LLMOps CI/CD, Deployment, Reliability &amp; Security",
        focus_areas="System design interview structure, RAG/agentic/real-time/batch archetypes, Little's-Law capacity estimation, vector-DB lifecycle, artifact lineage &amp; CI/CD gating, progressive rollout &amp; rollback criteria, retry/circuit-breaker reliability, data/tool-level authorization, end-to-end case studies",
