...
"""
    ...
    # auto-render needed more time to finish before print-to-pdf fired. This topic's
    # modules are similarly formula-dense (Modules 01/04/05/09 especially), so the
...
def main():
    ...
    print("\n--- Compiling Master Advanced RAG Study Guide ---")
    master_html = os.path.join(base_dir, "advanced_rag_master_study_guide.html")
    master_pdf = os.path.join(base_dir, "advanced_rag_master_study_guide.pdf")

    master_modules = [
        "01_rag_fundamentals_and_architecture.md",
        "02_document_processing_chunking_and_lifecycle.md",
        "03_embeddings_for_retrieval.md",
        "04_vector_indexing_and_ann_search.md",
        "05_hybrid_retrieval_and_reranking.md",
        "06_query_understanding_and_optimization.md",
        "07_graphrag_and_structured_retrieval.md",
        "08_agentic_rag.md",
        "09_rag_evaluation_debugging_and_production.md",
    ]
    compile_document(
        master_modules,
        master_html,
        ...
        "Advanced RAG Curriculum Guide",
        subtitle="Chunking, Vector Indexing, Hybrid Retrieval, GraphRAG, Agentic RAG &amp; Production Hardening",
        focus_areas="Late Chunking, HNSW/IVF/PQ math, RRF fusion, GraphRAG, Agentic RAG, RAG debugging methodology",
        includes="Step-by-Step Numerical Hand Calculations, Python Implementations, SVG/HTML Diagrams",
    )

    print("\n--- Compiling Advanced RAG Interview Q&A Cheatsheet ---")
    qa_html = os.path.join(base_dir, "advanced_rag_interview_cheatsheet.html")
    qa_pdf = os.path.join(base_dir, "advanced_rag_interview_cheatsheet.pdf")

    compile_document(
        ["10_advanced_rag_interview_questions.md"],
        qa_html,
        qa_pdf,
        "Advanced RAG Interview Q&A Cheatsheet",
        "Advanced RAG — 59 Interview Questions & Answers",
        subtitle="Real Measured Results from This Topic's Own Executed Notebooks, Grounded in Every Module's Hand Calculations",
        focus_areas="RAG fundamentals, chunking/lifecycle, embeddings, ANN indexing, hybrid retrieval, query transformation, GraphRAG, Agentic RAG, evaluation & debugging",
