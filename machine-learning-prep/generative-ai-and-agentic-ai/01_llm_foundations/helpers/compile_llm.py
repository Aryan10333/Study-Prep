...
def preprocess_markdown(text, file_name):
    ...
    # 4. Strip frontmatter if present and replace it with Module number and title heading
...
<div class="cover-page" style="text-align: center; padding-top: 140px; page-break-after: always;">
    ...
    <div style="margin-top: 60px; font-size: 14px; color: #475569; line-height: 1.8;">
        ...
        <p><b>Focus Areas:</b> Attention Math, GQA/MQA, KV Cache math, FlashAttention, PagedAttention, MoE routing, Deep Thinking TTC</p>
        <p><b>Includes:</b> Step-by-Step Numerical Hand Calculations, PyTorch Implementations, SVG/HTML Diagrams</p>
    </div>
</div>
...
"""
    ...
    temp_user_data = os.path.join(os.environ.get("TEMP", r"C:\Windows\Temp"), "edge_pdf_dir_tmp_llm")
...
def main():
    ...
    print("\n--- Compiling Master LLM Foundations Study Guide ---")
    master_html = os.path.join(base_dir, "llm_foundations_master_study_guide.html")
    master_pdf = os.path.join(base_dir, "llm_foundations_master_study_guide.pdf")
    
    master_modules = [
        "01_transformer_core.md",
        "02_positional_encodings.md",
        "03_activation_normalization.md",
        "04_tokenization.md",
        "05_attention_variants.md",
        "06_kv_cache.md",
        "07_inference_optimizations.md",
        "08_pretraining.md",
        "09_frontier_models_moe_reasoning.md",
        "10_evaluation.md"
    ]
    compile_document(
        master_modules,
        ...
        "LLM Foundations Curriculum Guide"
    )

    print("\n--- Compiling LLM Foundations Interview Cheatsheet ---")
    cheatsheet_html = os.path.join(base_dir, "llm_foundations_interview_cheatsheet.html")
    cheatsheet_pdf = os.path.join(base_dir, "llm_foundations_interview_cheatsheet.pdf")
    
    cheatsheet_modules = [
        "11_llm_interview_questions.md"
    ]
    compile_document(
        cheatsheet_modules,
        cheatsheet_html,
        ...
        "LLM Foundations Interview Cheatsheet"
    )
