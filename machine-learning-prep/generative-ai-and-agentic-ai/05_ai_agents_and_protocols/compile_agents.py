...
<div class="cover-page" style="text-align: center; padding-top: 140px; page-break-after: always;">
    ...
    <h1 style="font-size: 30px; color: #0f172a; margin-bottom: 12px; line-height: 1.25; border: none; padding: 0;">
        Part 5: AI Agents and Protocols
    </h1>
    <h2 style="font-size: 18px; color: #3b82f6; font-weight: 500; margin-bottom: 40px; border: none;">
        Multi-Agent Orchestration, Memory Systems, Tool Calling, and MCP Protocols Study Guide
    </h2>
    ...
    <div style="margin-top: 60px; font-size: 13px; color: #475569; line-height: 1.8;">
        <p><b>Target Persona:</b> Senior AI Engineer / Agent Systems Architect (~3 YOE)</p>
        <p><b>Core Modules:</b> Agent Fundamentals, Reasoning & Planning, Memory Systems, Tool Calling & MCP, Multi-Agent Patterns, Orchestration Frameworks, Evaluation, Production Systems, Failures, and High-Frequency Questions.</p>
        <p><b>Includes:</b> ReAct Loop traces, sliding-window and summarization memory traces, structured output extraction schema validations, LangGraph workflow tickets routing state mappings, cooperative code review loops, and async throughput queues.</p>
    </div>
</div>
...
<div class="toc-page" style="page-break-after: always; padding-top: 20px;">
    ...
    <ul style="list-style-type: none; padding-left: 0; margin-top: 20px;">
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#module-01-agent-fundamentals" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 01: Agent Fundamentals</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#module-02-reasoning-and-planning" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 02: Reasoning and Planning</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#module-03-memory-systems" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 03: Memory Systems</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#module-04-tool-calling-and-mcp" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 04: Tool Calling and Model Context Protocol (MCP)</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#module-05-multi-agent-systems" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 05: Multi-Agent Systems</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#module-06-agent-orchestration-and-frameworks" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 06: Agent Orchestration and Frameworks</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#module-07-agent-evaluation" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 07: Agent Evaluation</a></li>
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#module-08-production-agents" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 08: Production Agents</a></li>
        ...
        <li style="margin-bottom: 12px; font-size: 14px; border-bottom: 1px dashed #e2e8f0; padding-bottom: 6px;"><a href="#module-10-ai-agents-high-frequency-interview-question-bank" style="text-decoration: none; color: #2563eb; font-weight: 600;">Module 10: AI Agents High-Frequency Interview Question Bank</a></li>
    </ul>
</div>
