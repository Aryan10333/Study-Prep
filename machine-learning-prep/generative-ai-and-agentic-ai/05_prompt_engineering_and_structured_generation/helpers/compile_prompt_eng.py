...
"""
    ...
    #
    # virtual-time-budget set to 30000ms (not the older 8000ms default): this topic
    # has formula-bearing modules (01, 02, 03, 04, 09) plus 6 inline SVG diagrams, so
...
def main():
    ...
    print("\n--- Compiling Master Prompt Engineering & Structured Generation Study Guide ---")
    master_html = os.path.join(base_dir, "prompt_engineering_master_study_guide.html")
    master_pdf = os.path.join(base_dir, "prompt_engineering_master_study_guide.pdf")

    master_modules = [
        "01_prompting_fundamentals_and_instruction_hierarchy.md",
        "02_reasoning_elicitation_techniques.md",
        "03_structured_output_and_schema_constrained_generation.md",
        "04_constrained_decoding_and_grammar_based_generation.md",
        "05_prompt_optimization_and_automatic_prompt_engineering.md",
        "06_context_assembly_and_retrieval_integration.md",
        "07_prompt_evaluation_testing_and_versioning.md",
        "08_prompt_injection_jailbreaking_and_defense.md",
        "09_production_prompt_engineering_templating_and_portability.md",
    ]
    compile_document(
        master_modules,
        master_html,
        ...
        "Prompt Engineering & Structured Generation Curriculum Guide",
        subtitle="Instruction Hierarchy, Reasoning Elicitation, Structured Output, Constrained Decoding, Optimization &amp; Production Prompting",
        focus_areas="Instruction hierarchy, CoT/self-consistency, JSON mode vs. structured outputs vs. function calling, logit masking, DSPy-style optimization, context assembly, prompt evaluation, injection defense, caching/portability",
